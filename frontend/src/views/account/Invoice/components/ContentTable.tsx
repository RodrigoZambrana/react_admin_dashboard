...
const ContentTable = ({
    ...
    const resolvedMode = resource === 'budgets' ? 'budget' : 'order'
    const roundAmount = useMemo(
        () => createSalesDocumentRounder(resolvedMode),
        [resolvedMode],
    )
    ...
    const tableColumns = useMemo(() => {
        ...
        const priceColumn = columnHelper.accessor('price', {
            ...
            cell: (props) => {
                ...
                return <span>{formatAmount(roundedPrice, displayCurrency)}</span>
            },
        })
        ...
        const totalColumn = columnHelper.display({
            ...
            cell: (props) => {
                ...
                const roundedTotal = roundAmount(computedTotal)
                return <span>{formatAmount(roundedTotal, displayCurrency)}</span>
            },
        })
