...
const appsNavigationConfig: NavigationTree[] = [
    {
        ...
        subMenu: [
            ...
            },
            {
                ...
                subMenu: [
                    ...
                    },
                    {
                        ...
                        title: 'Funnel',
                        translateKey: 'nav.appsAnalytics.funnel',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: getRolesForFeature(FEATURES.SETTINGS),
                        subMenu: [],
                    },
                    {
                        ...
                        title: 'Marketing',
                        translateKey: 'nav.appsAnalytics.marketing',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: getRolesForFeature(FEATURES.SETTINGS),
                        subMenu: [],
                    },
                    {
                        ...
                        title: 'Products',
                        translateKey: 'nav.appsAnalytics.products',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: getRolesForFeature(FEATURES.SETTINGS),
                        subMenu: [],
                    },
                    {
                        ...
                        title: 'Behavior',
                        translateKey: 'nav.appsAnalytics.behavior',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: getRolesForFeature(FEATURES.SETTINGS),
                        subMenu: [],
                    },
                    {
                        ...
                        title: 'Conversions',
                        translateKey: 'nav.appsAnalytics.conversions',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: getRolesForFeature(FEATURES.SETTINGS),
                        subMenu: [],
                    },
                    {
                        ...
                        translateKey: 'nav.appsAnalytics.growthInsights',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: getRolesForFeature(FEATURES.SETTINGS),
                        subMenu: [],
            ...
            },
            {
                ...
                subMenu: [
                    {
                        key: 'appsCms.generalPages',
                        path: `${APP_PREFIX_PATH}/cms/pages?scope=general`,
                    ...
                    {
                        key: 'appsCms.storePages',
                        path: `${APP_PREFIX_PATH}/cms/pages?scope=store`,
                    ...
                    },
                    {
                        ...
                        title: 'Media',
                        translateKey: 'nav.appsCms.media',
                        icon: 'media',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: getRolesForFeature(FEATURES.SETTINGS),
                        subMenu: [],
