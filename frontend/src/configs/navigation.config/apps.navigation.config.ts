...
const aiSubMenu: NavigationTree[] = [
    {
        key: 'appsAi.home',
        path: `${APP_PREFIX_PATH}/settings/ai`,
        title: 'Home',
        translateKey: 'nav.appsAi.home',
        icon: '',
        type: NAV_ITEM_TYPE_ITEM,
    ...
    },
    {
        ...
        title: 'Runtime',
        translateKey: 'nav.appsAi.runtime',
        icon: '',
        type: NAV_ITEM_TYPE_ITEM,
        authority: getRolesForFeature(FEATURES.SETTINGS),
        subMenu: [],
    },
    {
        ...
        translateKey: 'nav.appsAi.knowledgeOverview',
        icon: '',
        type: NAV_ITEM_TYPE_ITEM,
        authority: getRolesForFeature(FEATURES.SETTINGS),
        subMenu: [],
    },
    {
        ...
        translateKey: 'nav.appsAi.knowledgeSnapshots',
        icon: '',
        type: NAV_ITEM_TYPE_ITEM,
        authority: getRolesForFeature(FEATURES.SETTINGS),
        subMenu: [],
    },
    {
        ...
        translateKey: 'nav.appsAi.knowledgeManageArticles',
        icon: '',
        type: NAV_ITEM_TYPE_ITEM,
        authority: getRolesForFeature(FEATURES.SETTINGS),
        subMenu: [],
    },
    {
        ...
        translateKey: 'nav.appsAi.knowledgeQuoteProfiles',
        icon: '',
        type: NAV_ITEM_TYPE_ITEM,
        authority: getRolesForFeature(FEATURES.SETTINGS),
        subMenu: [],
    },
    {
        ...
        title: 'Documents',
        translateKey: 'nav.appsAi.knowledgeDocuments',
        icon: '',
        type: NAV_ITEM_TYPE_ITEM,
        authority: getRolesForFeature(FEATURES.SETTINGS),
        subMenu: [],
    },
    {
        ...
        title: 'Candidates',
        translateKey: 'nav.appsAi.knowledgeCandidates',
        icon: '',
        type: NAV_ITEM_TYPE_ITEM,
        authority: getRolesForFeature(FEATURES.SETTINGS),
        subMenu: [],
    },
    {
        ...
        title: 'Raw Events',
        translateKey: 'nav.appsAi.knowledgeRawEvents',
        icon: '',
        type: NAV_ITEM_TYPE_ITEM,
        authority: getRolesForFeature(FEATURES.SETTINGS),
        subMenu: [],
    },
    {
        ...
        translateKey: 'nav.appsAi.knowledgeIngestionRuns',
        icon: '',
        type: NAV_ITEM_TYPE_ITEM,
        authority: getRolesForFeature(FEATURES.SETTINGS),
        subMenu: [],
    },
    {
        ...
        title: 'Feedback',
        translateKey: 'nav.appsAi.knowledgeFeedback',
        icon: '',
        type: NAV_ITEM_TYPE_ITEM,
        authority: getRolesForFeature(FEATURES.SETTINGS),
        subMenu: [],
    },
    {
        ...
        translateKey: 'nav.appsAi.knowledgeConversationBundles',
        icon: '',
        type: NAV_ITEM_TYPE_ITEM,
        authority: getRolesForFeature(FEATURES.SETTINGS),
        subMenu: [],
    },
    {
        ...
        translateKey: 'nav.appsAi.knowledgeNegativeExamples',
        icon: '',
        type: NAV_ITEM_TYPE_ITEM,
        authority: getRolesForFeature(FEATURES.SETTINGS),
        subMenu: [],
            ...
            // Clientes
            {
                ...
                subMenu: [
                    ...
                    },
                    {
                        ...
                        title: 'Mensajes',
                        translateKey: 'nav.appsCrm.messages',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: getRolesForFeature(FEATURES.CUSTOMERS),
                        subMenu: [],
