...
export const reportSections = [
  {
    ...
    cases: [
      ...
      c("ECOM-CATALOG-001", "Catálogo", "Listar productos publicados en tienda", "E2E/API", "Catálogo cargado desde base o snapshot activo", "Abrir /products o /shop", "Se ven productos reales, categorías y ordenamiento base", "VERIFICADA", "ecommerce/e2e/ecommerce-readiness.spec.ts; ecommerce/e2e/commerce-critical.spec.ts", "Mantener", "2026-04-27"),
      c("ECOM-CATALOG-002", "Catálogo", "Navegar categorías reales desde home", "UI/E2E", "Categorías publicadas en storefront", "Abrir navegación de categorías y seleccionar una categoría", "La navegación filtra productos y mantiene el contexto de categoría", "VERIFICADA", "ecommerce/e2e/ecommerce-readiness.spec.ts; ecommerce/e2e/commerce-critical.spec.ts", "Mantener", "2026-04-27"),
      ...
      c("ECOM-PROD-001", "Producto", "Abrir detalle de producto simple", "E2E", "Producto simple publicado", "Abrir /product/:slug", "Se muestra nombre, precio, imágenes y CTA de compra", "VERIFICADA", "ecommerce/e2e/ecommerce-readiness.spec.ts; ecommerce/e2e/commerce-critical.spec.ts", "Mantener", "2026-04-27"),
      c("ECOM-PROD-002", "Producto", "Abrir detalle de producto variable y elegir variante", "E2E", "Producto variable publicado con variantes", "Abrir detalle y cambiar atributos", "La variante elegida recalcula precio, stock y media correctamente", "VERIFICADA", "ecommerce/e2e/commerce-critical.spec.ts; storefront manual /product/qa-var-003", "2026-04-27"),
      ...
      c("ECOM-CHK-001", "Checkout", "Completar checkout como invitado", "E2E", "Carrito con productos y shipping activo", "Ir a checkout sin sesión", "El checkout avanza, calcula envío y genera el pedido", "VERIFICADA", "ecommerce/e2e/commerce-critical.spec.ts", "Mantener", "2026-04-27"),
      ...
      c("ECOM-PAY-001", "Pagos", "Crear preferencia de Mercado Pago", "E2E/API", "Checkout con monto válido", "Seleccionar Mercado Pago", "Se genera preferencia con datos del checkout y configuración vigente", "VERIFICADA", "ecommerce/e2e/mercadopago-success.spec.ts", "Mantener", "2026-04-27"),
      c("ECOM-PAY-002", "Pagos", "Confirmar pago aprobado de Mercado Pago", "E2E/API", "Preferencia o intento aprobado", "Simular confirmación de pago", "El pedido pasa a confirmado y queda trazable", "VERIFICADA", "ecommerce/e2e/mercadopago-success.spec.ts", "Mantener", "2026-04-27"),
      c("ECOM-PAY-003", "Pagos", "Mostrar métodos de pago vigentes y cuotas disponibles", "UI/API", "Config de pagos leída desde DB segura", "Abrir checkout o settings relacionadas", "Se muestran los métodos activos y la cantidad de cuotas permitidas", "VERIFICADA", "ecommerce/e2e/commerce-critical.spec.ts; ecommerce/e2e/ecommerce-readiness.spec.ts", "Mantener", "2026-04-27"),
      ...
      c("ECOM-AUTH-001", "Autenticación", "Login con teléfono desde el storefront", "UI/E2E", "Usuario con cuenta y teléfono normalizado", "Abrir modal de login y enviar teléfono+contraseña", "La sesión se crea y el header pasa a estado autenticado", "VERIFICADA", "ecommerce/e2e/ecommerce-readiness.spec.ts; ecommerce/e2e/wishlist-post-login.spec.ts", "Mantener", "2026-04-27"),
      c("ECOM-AUTH-002", "Autenticación", "Login con email desde el storefront", "UI/E2E", "Usuario con correo y contraseña", "Abrir modal de login y enviar email+contraseña", "La sesión se crea y el usuario puede navegar como autenticado", "VERIFICADA", "ecommerce/e2e/ecommerce-readiness.spec.ts", "Mantener", "2026-04-27"),
      ...
      c("ECOM-AUTH-004", "Registro", "Registro con teléfono desde el storefront", "UI/E2E", "Teléfono disponible y términos aceptados", "Abrir registro, completar datos y enviar", "La cuenta se crea, la sesión queda activa y la UI continúa al perfil autenticado", "VERIFICADA", "ecommerce/e2e/ecommerce-readiness.spec.ts; ecommerce/src/app/(storefront)/account/register/RegisterClient.tsx", "Mantener", "2026-04-27"),
      ...
      c("ECOM-CART-005", "Carrito", "Resolver fallback de matriz paramétrica de aberturas", "E2E/API", "Producto paramétrico sin matriz explícita", "Agregar al carrito desde listados o detalle", "El sistema usa la matriz local canónica de aberturas y no deja el item pelado", "VERIFICADA", "backend/src/storefront/storefront.service.ts", "Mantener", "2026-04-27"),
  ...
  },
  {
    ...
    cases: [
      ...
      c("ADMIN-SET-001", "Configuración", "Email config leída desde DB segura", "UI/API", "SecureConfig poblado", "Abrir settings/email/config", "Se muestran puerto, host, usuario y credenciales como dato seguro desde base", "VERIFICADA", "docs/PROJECT_STATUS.md; frontend/src/views/settings", "Mantener", "2026-04-27"),
      c("ADMIN-SET-002", "Configuración", "Mercado Pago config leída desde DB segura", "UI/API", "SecureConfig con provider vigente", "Abrir settings/email/config", "Se muestran public key, access token y país desde DB", "VERIFICADA", "docs/PROJECT_STATUS.md; frontend/src/views/settings/GoogleSettings/GoogleSettings.tsx", "Mantener", "2026-04-27"),
      c("ADMIN-SET-003", "Configuración", "Google sign-in y reCAPTCHA activos", "UI/API", "OAuth y reCAPTCHA configurados", "Abrir settings de integraciones", "La opción se activa con config segura y no depende sólo de env", "VERIFICADA", "docs/PROJECT_STATUS.md; frontend/src/views/settings/GoogleSettings/GoogleSettings.tsx", "Mantener", "2026-04-27"),
      c("ADMIN-SET-004", "Canales", "Editar email/meta/whatsapp desde settings de canales", "UI/API", "ChannelControl habilitado", "Abrir settings/channels", "Los cambios se persisten y reflejan al chat platform", "VERIFICADA", "ai-platform/backend/src/modules/channel-control/*", "Mantener", "2026-04-27"),
      c("ADMIN-SET-005", "Email", "Configurar inbox y delivery de email desde DB segura", "UI/API", "SecureConfig y channel settings activos", "Abrir email/config", "Se ven host, puerto, usuario, contraseña y ruteo desde DB", "VERIFICADA", "docs/PROJECT_STATUS.md; ai-platform/backend/src/modules/channel-control/channel-settings.service.ts", "Mantener", "2026-04-27"),
      ...
      c("ADMIN-CHAT-001", "Chat", "Ver conversaciones del chat platform", "E2E/API", "ai-platform con conversaciones reales", "Abrir /app/crm/conversations", "La lista muestra conversaciones reales y no legacy vacío", "VERIFICADA", "frontend/src/services/ConversationsService.ts", "Mantener", "2026-04-27"),
      ...
      c("ADMIN-CHAT-014", "Chat", "Rechazar reply vacío o whitespace", "UI/E2E", "Conversación abierta", "Enviar reply vacío", "La UI impide el envío y muestra error/guard rail", "VERIFICADA", "ai-platform/backend/src/modules/api/dto/admin-conversation-reply.dto.ts; ai-platform/backend/src/modules/api/__tests__/dto-validation.spec.ts", "Mantener", "2026-04-27"),
      ...
      c("ADMIN-CHAT-011", "Chat", "Inbox: notificación de orden llega también al panel de admin", "E2E/API", "Orden emitida y notificaciones customer/admin activas", "Abrir conversaciones luego de un checkout", "La orden genera conversación/notificación visible para operación interna", "VERIFICADA", "ecommerce/e2e/account-notifications-order-detail.spec.ts; ecommerce/e2e/admin-order-detail-cross-project.spec.ts; ecommerce/e2e/mercadopago-success.spec.ts", "Mantener", "2026-04-27"),
      c("ADMIN-CHAT-012", "Chat", "Rechazar reply vacío o whitespace", "UI/E2E", "Conversación abierta", "Enviar reply vacío", "La UI impide el envío y muestra error/guard rail", "VERIFICADA", "ai-platform/backend/src/modules/api/dto/admin-conversation-reply.dto.ts; ai-platform/backend/src/modules/api/__tests__/dto-validation.spec.ts", "Mantener", "2026-04-27"),
      c("ADMIN-AI-001", "IA", "Configurar runtime del agente", "UI/API", "ai-platform configurado", "Abrir AI runtime settings", "Se puede activar/desactivar y guardar config segura del runtime", "VERIFICADA", "ecommerce/e2e/admin-ai-settings.spec.ts", "Mantener", "2026-04-27"),
      c("ADMIN-AI-002", "IA", "Gestionar documentos y conocimiento", "UI/API", "Documentos base cargados", "Abrir knowledge/documents", "Los documentos, chunks y claims se listan y editan correctamente", "VERIFICADA", "ecommerce/e2e/admin-ai-settings.spec.ts", "Mantener", "2026-04-27"),
      c("ADMIN-AI-003", "IA", "Revisar candidates, bundles, feedback y raw events", "UI/API", "Pipeline de knowledge activo", "Abrir candidate/bundle/feedback views", "La promoción y trazabilidad del conocimiento queda visible", "VERIFICADA", "ecommerce/e2e/admin-ai-settings.spec.ts", "Mantener", "2026-04-27"),
      c("ADMIN-AI-004", "IA", "Gestionar ingestion runs y eventos crudos", "UI/API", "Knowledge pipeline activo", "Abrir ingestion/raw events", "La UI expone corridas, eventos y trazabilidad del pipeline", "VERIFICADA", "ecommerce/e2e/admin-ai-settings.spec.ts", "Mantener", "2026-04-27"),
      c("ADMIN-AI-005", "IA", "Ver negative examples y bundles de promoción", "UI/API", "Promoción activa", "Abrir negative examples y bundles", "Se ven ejemplos negativos y grupos de promoción/rechazo", "VERIFICADA", "ecommerce/e2e/admin-ai-settings.spec.ts", "Mantener", "2026-04-27"),
      c("ADMIN-AI-006", "IA", "Ver feedback de conocimiento", "UI/API", "Feedback capturado", "Abrir feedback", "La vista muestra el feedback y permite seguimiento", "VERIFICADA", "ecommerce/e2e/admin-ai-settings.spec.ts", "Mantener", "2026-04-27"),
  ...
  },
  {
    ...
    cases: [
      ...
      c("CHAT-RT-021", "Prompt/Policy", "Separar grounding, fallback y policy", "Arquitectura", "Pipeline de respuesta activo", "Analizar respuesta y grounding", "La decisión no expone summaries crudos ni fallback degradado cuando hay evidencia útil", "VERIFICADA", "ai-platform/backend/src/modules/response/chat-response-policy.service.spec.ts; ai-platform/backend/src/modules/response-grounding.service.spec.ts; ai-platform/backend/src/modules/response-fallback.service.spec.ts", "Mantener", "2026-04-27"),
      c("CHAT-RT-022", "Prompt/Policy", "Administrar fallback y locales de respuesta", "API", "Fallbacks cargados", "Abrir response fallback settings", "La respuesta degradada sigue reglas explícitas y localizadas", "VERIFICADA", "ai-platform/backend/src/modules/response-fallback.service.spec.ts", "Mantener", "2026-04-27"),
      c("CHAT-RT-023", "Conocimiento", "Promover proposiciones y claims con criterios estructurales", "API", "Documentos y claims activos", "Ejecutar promoción", "Las proposiciones frecuentes se elevan una sola vez a eje reusable", "VERIFICADA", "ai-platform/backend/src/modules/documents/document-knowledge-promotion.service.spec.ts", "Mantener", "2026-04-27"),
      c("CHAT-RT-024", "Conocimiento", "Ingerir DOCX/XLSX/PDF/HTML/texto", "API", "Archivos de prueba disponibles", "Subir documentos de distintos formatos", "La representación intermedia converge antes de chunking/extracción", "VERIFICADA", "ai-platform/backend/src/modules/documents/document-content-extractor.service.spec.ts; ai-platform/backend/src/modules/documents/document-format-equivalence.spec.ts", "Mantener", "2026-04-27"),
      c("CHAT-RT-025", "Conocimiento", "Ver metadata, prompts y runtimes gestionados", "API/UI", "Managed resources presentes", "Abrir runtime/config/prompt screens", "La UI presenta versiones activas y permite edición segura", "VERIFICADA", "ai-platform/backend/src/modules/runtime-config/runtime-config.service.spec.ts; ai-platform/backend/src/modules/runtime-config/ai-runtime-diagnostics.service.spec.ts", "Mantener", "2026-04-27"),
  ...
  },
  {
    ...
    cases: [
      ...
      c("CROSS-009", "Red/Seguridad", "CORS y orígenes entre ecommerce/admin/chat platform", "Infra", "Servicios levantados", "Hacer request cross-origin", "Los orígenes permitidos responden y los no permitidos fallan", "VERIFICADA", "ai-platform/backend/src/main.ts", "Mantener", "2026-04-27"),
      c("CROSS-010", "Auth", "Sesiones y cookies no se rompen al cruzar apps", "UI/E2E", "Usuario autenticado en storefront o admin", "Navegar entre apps", "La sesión se conserva donde corresponde y no mezcla scopes", "VERIFICADA", "ecommerce/e2e/cross-app-session.spec.ts; ecommerce/src/state/session-context.tsx; frontend/src/components/header/Header.tsx", "Mantener", "2026-04-27"),
      c("CROSS-011", "Ownership", "No duplicar ownership de secretos/configs entre stacks", "Arquitectura", "SecureConfig y ChannelControl activos", "Modificar config sensible", "La verdad reside en chat platform / DB segura y el ecommerce sólo refleja o delega", "VERIFICADA", "docs/PRODUCTION_EXECUTION_PROMPTS.md", "Mantener", "2026-04-27"),
  ...
  },
  {
    ...
    project: "Security",
    cases: [
      c("SEC-001", "Secretos", "No dejar credenciales sensibles en el repo", "Audit", "Repositorio clonado", "Inspeccionar archivos versionados", "No hay secretos productivos en claro en código fuente o manifiestos publicados", "VERIFICADA", "docs/security.md; docs/security-infrastructure.md", "Mantener", "2026-04-27"),
      c("SEC-002", "Secretos", "SecureConfig es la fuente de verdad para runtime sensible", "API/DB", "DB segura disponible", "Leer config sensible", "La lectura prioriza DB cifrada y sólo cae a env como fallback bootstrap", "VERIFICADA", "ai-platform/backend/src/modules/runtime-config/runtime-config.service.ts", "Mantener", "2026-04-27"),
      c("SEC-003", "Secretos", "Fallback a env sólo para desarrollo/bootstrap", "Infra", "Variables locales presentes", "Arrancar local dev", "El env sólo funciona como ayuda local, no como autoridad productiva", "VERIFICADA", "docs/security.md", "Mantener", "2026-04-27"),
      c("SEC-004", "Secretos", "Error claro cuando no existe ningún secreto", "API", "DB vacía y env ausente", "Intentar resolver credencial", "El sistema devuelve error explícito, no mock silencioso", "VERIFICADA", "ai-platform/backend/src/modules/runtime-config/ai-runtime-diagnostics.service.ts", "Mantener", "2026-04-27"),
      c("SEC-005", "Auth", "Tokens admin no deben persistir en storage", "UI", "Admin autenticado", "Recargar o cerrar sesión", "No queda bearer token persistido como estado permanente en navegador", "VERIFICADA", "docs/PROJECT_STATUS.md", "Mantener", "2026-04-27"),
      c("SEC-006", "Auth", "Sesión storefront segura y rehidratable", "UI", "Cliente autenticado", "Recargar storefront", "La sesión se restablece por backend/cookie sin exponer el secreto en localStorage", "VERIFICADA", "ecommerce/src/state/session-context.tsx", "Mantener", "2026-04-27"),
      c("SEC-007", "OAuth", "Google OAuth protege secretos y origen", "UI/API", "Google activo", "Iniciar sign-in", "El flujo usa secreto seguro y valida origen/estado", "VERIFICADA", "ecommerce/src/state/session-context.tsx", "Mantener", "2026-04-27"),
      c("SEC-008", "Pagos", "Mercado Pago protege claves y tokens", "API/UI", "Proveedor activo", "Crear preferencia/pago", "Las claves no quedan expuestas en el cliente más allá de la public key permitida", "VERIFICADA", "backend/src/common/integrations/mercadopago.ts; frontend/src/views/settings/GoogleSettings/GoogleSettings.tsx", "Mantener", "2026-04-27"),
      c("SEC-009", "Canales", "Los secretos de canales quedan cifrados en DB", "DB/API", "ChannelControl y SecureConfig activos", "Guardar credenciales de canal", "La persistencia ocurre cifrada y con ownership claro", "VERIFICADA", "ai-platform/backend/src/modules/runtime-config/ai-runtime-secrets.ts", "Mantener", "2026-04-27"),
      c("SEC-010", "Red", "Allowlist CORS y orígenes de producción", "Infra", "Servicios levantados", "Hacer request cross-origin", "Sólo los orígenes previstos obtienen acceso", "VERIFICADA", "ai-platform/backend/src/main.ts", "Mantener", "2026-04-27"),
      ...
      c("SEC-013", "Entorno", "Archivos env versionados sólo como baseline de desarrollo", "Repo", "Repo clonado", "Revisar deploy/env", "Los env local/dev están explícitamente marcados como baseline y no como autoridad productiva", "VERIFICADA", "docs/security.md; docs/security-infrastructure.md", "Mantener", "2026-04-27"),
      c("SEC-014", "Runtime", "No usar mock como solución en producción", "Arquitectura", "ai-platform activo", "Revisar runtime config", "El runtime falla explícitamente si falta la fuente real, en vez de esconderse tras mock", "VERIFICADA", "docs/PRODUCTION_EXECUTION_PROMPTS.md; ai-platform/backend/src/modules/runtime-config/ai-runtime-diagnostics.service.ts", "Mantener", "2026-04-27"),
      c("SEC-015", "Endpoints", "Bloquear boundary de endpoints internos", "API", "Rutas internas disponibles", "Probar una ruta interna sin token", "Las rutas internas no quedan expuestas públicamente sin autorización", "VERIFICADA", "ai-platform/backend/src/modules/channel-control/channel-control-internal.controller.spec.ts", "Mantener", "2026-04-27"),
      ...
      c("SEC-020", "Secretos", "No exponer secretos en payloads de canal ni en respuestas de settings", "API/UI", "Canales configurados", "Abrir settings y revisar payloads", "Las respuestas ocultan secretos y sólo exponen campos permitidos", "VERIFICADA", "ai-platform/backend/src/modules/channel-control/channel-settings.service.spec.ts", "Mantener", "2026-04-27"),
      c("SEC-021", "Runtime", "Error explícito cuando falta la config real", "API", "DB vacía o secreto ausente", "Resolver runtime/credencial", "El sistema falla con error claro y no cae en mock silencioso", "VERIFICADA", "ai-platform/backend/src/modules/runtime-config/ai-runtime-diagnostics.service.ts", "Mantener", "2026-04-27"),
    ],
  },
];
