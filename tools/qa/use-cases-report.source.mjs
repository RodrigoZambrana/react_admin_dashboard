...
export const reportSections = [
  {
    ...
    cases: [
      ...
      c("ECOM-SEARCH-001", "Búsqueda", "Buscar con resultados visibles y navegar al producto correcto", "UI/E2E", "Buscador activo y catálogo con coincidencias", "Buscar una palabra que devuelva resultados y abrir un resultado", "La búsqueda lista resultados reales, permite abrir el PDP y conserva el contexto de búsqueda", "VERIFICADA", "ecommerce/e2e/storefront-search.spec.ts; ecommerce/src/components/search-box/SearchInputWithCategory.tsx; ecommerce/src/app/shop/components/ShopSearchIntelligence.tsx", "Mantener", "2026-05-10"),
      c("ECOM-SEARCH-002", "Búsqueda", "Buscar sin resultados y mostrar salida útil", "UI/E2E", "Buscador activo", "Buscar una cadena sin coincidencias", "La pantalla no queda vacía: muestra empty state, sugerencias o fallback al catálogo", "VERIFICADA", "ecommerce/e2e/storefront-search.spec.ts; ecommerce/src/components/search-box/SearchInputWithCategory.tsx; ecommerce/src/app/shop/components/ShopSearchIntelligence.tsx", "Mantener", "2026-05-10"),
      ...
      c("ECOM-CAN-001", "Canónicas", "Resolver slug canónico monoblock con su configuración correcta", "E2E/UI", "Producto canónico publicado y configuración base disponible", "Abrir el slug canónico monoblock y recorrer PDP", "La ruta resuelve la canónica correcta, conserva canonicalConfiguration y el PDP no cae en fallback incorrecto", "VERIFICADA", "ecommerce/e2e/storefront-canonical-handoff.spec.ts; ecommerce/src/components/products/ProductIntro.tsx; ecommerce/src/lib/page-metadata.ts; ecommerce/src/lib/analytics/product-context.ts; backend/src/storefront/storefront.service.ts", "Mantener", "2026-05-10"),
      ...
      c("ECOM-MOB-001", "Mobile-first", "Ejecutar home, catálogo, PDP, carrito y checkout en viewport móvil", "E2E/UI", "Local storefront activo", "Abrir en viewport pequeño y recorrer el flujo principal", "La navegación móvil sigue usable, los CTAs quedan accesibles y no hay overlays o menús que bloqueen el flujo", "VERIFICADA", "ecommerce/e2e/mobile-storefront-core.spec.ts; ecommerce/src/components/mobile-navigation/index.tsx; ecommerce/src/app/shop/layout.tsx", "Mantener", "2026-05-10"),
      c("ECOM-PERF-001", "Performance", "Cargar la superficie crítica sin pantalla en blanco ni CTA oculto", "UI", "Storefront con contenido publicado", "Hacer hard refresh en home, listing y PDP", "La primera pintura muestra contenido utilizable, el CTA principal queda visible y la navegación sigue respondiendo sin layout roto", "VERIFICADA", "ecommerce/e2e/storefront-visual-stability.spec.ts; ecommerce/src/app/(storefront)/page.tsx; ecommerce/src/app/shop/page.tsx; ecommerce/src/components/products/ProductIntro.tsx", "Mantener", "2026-05-10"),
