...
import { extractDocxText } from './office-archive.utils';
import {
...
@Injectable()
export class UploadDocxDocumentAdapter implements TenantResourceUploadAdapter {
  readonly kind = 'docx_upload' as const;
  ...
  async extractFromUpload(
    ...
    return {
      ...
      textContent: extractDocxText(input.buffer),
    };
  }
}
