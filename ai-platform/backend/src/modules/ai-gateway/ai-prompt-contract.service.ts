...
export class AiPromptContractService {
  ...
  buildResponseContractLines() {
    return [
      ...
      'If the backend-approved answer is list-shaped but the user asked a normal conversational question, rewrite it into one short natural sentence.',
      'For follow-up informational turns, answer the newly requested detail directly instead of repeating broad prior context.',
