...
export function DashboardPage() {
  ...
  const summaryCards = [
    ...
    },
    {
      ...
      tone: 'bg-info',
      hint: 'Prompts, locales, configs, fallbacks, knowledge',
    },
  ];
          ...
          <div className="card flex-fill">
            ...
            <div className="card-body">
              <div className="react-roadmap-note">
                <p>
                  Wave 6 productizes operator workflows over governed runtime resources.
                  It does not yet deliver the future async user-chat behavior.
                </p>
                <ul className="mb-0">
                  <li>Wave 7 will add knowledge and chat test center operations.</li>
                  <li>
