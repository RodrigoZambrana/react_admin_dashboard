...
export declare class BudgetsController {
    ...
    exportBudgets(q: any): Promise<StreamableFile>;
    importBudgets(req: FastifyRequest): Promise<{
        imported: number;
        errors: {
            row: number;
            message: string;
    ...
    getBudgetDetails(id: number): Promise<{
        id: number;
        date: Date;
        validUntilDate: string | null;
        validityDate: string | null;
    ...
    getBudgetPdf(id: number): Promise<StreamableFile>;
    createBudget(dto: CreateOrderDto): Promise<boolean>;
    replaceBudget(id: number, dto: CreateOrderDto): Promise<boolean>;
    updateBudgetComment(id: number, body: {
        comment?: string;
    }): Promise<boolean>;
    updateBudgetStatus(id: number, body: {
        status: number;
        force?: boolean;
    }): Promise<boolean>;
    updateBudgetPaymentMethod(id: number, body: {
        paymentMehod?: string | number | null;
    }): Promise<boolean>;
    uploadBudgetDocument(id: number, req: FastifyRequest): Promise<{
        path: string | null;
        name: string | null;
        mime: string | null;
        size: number | null;
    ...
    sendBudget(id: number, req: FastifyRequest): Promise<{
        budgetId: number;
        statusId: number;
        validUntilDate: Date;
        validityDate: Date;
    ...
    confirmBudget(id: number, req: FastifyRequest): Promise<{
        budgetId: number;
        orderId: number;
    }>;
}
