import type { HomeLayoutDefinition, HomeModuleConfig } from '../types'

type ModuleOverrides = Partial<Omit<HomeModuleConfig, 'id' | 'type'>>

const hero = (id: string, overrides: ModuleOverrides = {}): HomeModuleConfig => ({
  id,
  type: 'hero',
...
const productGrid = (id: string, overrides: ModuleOverrides = {}): HomeModuleConfig => ({
  id,
  type: 'product-grid',
  title: 'New arrivals',
...
const productCarousel = (id: string, overrides: ModuleOverrides = {}): HomeModuleConfig => ({
  id,
...
const featureStrip = (id: string, overrides: ModuleOverrides = {}): HomeModuleConfig => ({
  id,
  type: 'usp-strip',
...
const categoryShowcase = (id: string, overrides: ModuleOverrides = {}): HomeModuleConfig => ({
  id,
  type: 'category-grid',
...
const banner = (id: string, overrides: ModuleOverrides = {}): HomeModuleConfig => ({
  id,
  type: 'banner',
...
const newsletter = (id: string, overrides: ModuleOverrides = {}): HomeModuleConfig => ({
  id,
  type: 'newsletter',
...
const testimonials = (id: string, overrides: ModuleOverrides = {}): HomeModuleConfig => ({
  id,
  type: 'testimonial',
...
const blogTeaser = (id: string, overrides: ModuleOverrides = {}): HomeModuleConfig => ({
  id,
  type: 'blog-teaser',
...
function storyHighlight(id: string, overrides: ModuleOverrides = {}): HomeModuleConfig {
  return {
    id,
